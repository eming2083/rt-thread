...
#define ETH_RMII_RST_PORN 				GPIOD
#define ETH_RMII_RST_PIN 				GPIO_PIN_12
...
static void phy_pin_reset(void)
{
	...
	HAL_GPIO_WritePin(ETH_RMII_RST_PORN, ETH_RMII_RST_PIN, GPIO_PIN_RESET);
	delay_ms(100);
	HAL_GPIO_WritePin(ETH_RMII_RST_PORN, ETH_RMII_RST_PIN, GPIO_PIN_SET);
	delay_ms(100);
...
static void GPIO_Configuration(void)
{
	...
	GPIO_InitStructure.Pin = ETH_RMII_RST_PIN;
	GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_OD;
	GPIO_InitStructure.Pull = GPIO_PULLUP;
	GPIO_InitStructure.Speed = GPIO_SPEED_FAST;
	HAL_GPIO_Init(ETH_RMII_RST_PORN, &GPIO_InitStructure);
